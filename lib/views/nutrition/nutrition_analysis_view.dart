...
class _NutritionAnalysisDetailViewState extends State<NutritionAnalysisDetailView> {
  ...
  Future<void> _logMeal(NutritionAnalysis analysis) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('Registrar como comida'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Análisis nutricional')),
        ...
        builder: (context, analysis) {
          return ListView(
            ...
            children: [
              ...
              const Text('Alimentos detectados',
                  style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
              const SizedBox(height: 8),
              if (analysis.detectedFoods.isEmpty)
                const Text(
                  'No se identificaron alimentos.',
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Registrar como comida'),
              ),
            ],
          );
        },
